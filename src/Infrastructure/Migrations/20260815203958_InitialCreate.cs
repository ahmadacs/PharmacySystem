        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenericNameId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Medicines_GenericNames_GenericNameId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineVariants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicineVariants_Medicines_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DispensingRecords_Pharmacists_PharmacistId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicineVariantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicineBatches_MedicineVariants_MedicineVariantId",
                        column: x => x.MedicineVariantId,
                        principalTable: "MedicineVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrescriptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicineVariantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DosageInstructions = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrescriptionItems_MedicineVariants_MedicineVariantId",
                        column: x => x.MedicineVariantId,
                        principalTable: "MedicineVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispensingRecordItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispensingRecordItems_DispensingRecords_DispensingRecordId",
                        column: x => x.DispensingRecordId,
                        principalTable: "DispensingRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DispensingRecordItems_MedicineBatches_MedicineBatchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryAdjustments_MedicineBatches_MedicineBatchId",
                        column: x => x.MedicineBatchId,
                        principalTable: "MedicineBatches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispensingRecordItems_DispensingRecordId",
                table: "DispensingRecordItems",
                column: "DispensingRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_DispensingRecordItems_MedicineBatchId",
                table: "DispensingRecordItems",
                column: "MedicineBatchId");

            migrationBuilder.CreateIndex(
                name: "IX_DispensingRecords_DispensedAt",
                table: "DispensingRecords",
                column: "DispensedAt");

            migrationBuilder.CreateIndex(
                name: "IX_DispensingRecords_PharmacistId",
                table: "DispensingRecords",
                column: "PharmacistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenericNames_Name",
                table: "GenericNames",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InventoryAdjustments_AdjustedAt",
                table: "InventoryAdjustments",
                column: "AdjustedAt");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryAdjustments_MedicineBatchId",
                table: "InventoryAdjustments",
                column: "MedicineBatchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineBatches_MedicineVariantId_ExpiryDate",
                table: "MedicineBatches",
                columns: new[] { "MedicineVariantId", "ExpiryDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicines_GenericNameId",
                table: "Medicines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineVariants_MedicineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionItems_MedicineVariantId",
